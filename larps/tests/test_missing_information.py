...
from .util_test import create_group, create_characters_assigments, create_character_assigment, create_diets
...
class MissingInformationTests(TestCase):
    ...
    def test_get_missing_information(self):
        ...
        for missing_player_info in players_run1:
            ...
            self.assertEqual(missing_player_info["bookings"], None)
